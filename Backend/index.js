...
const mentorAuthenticator = (req,res,next) =>{
  ...
  try {
    ...
    return res.json({message:"user not authenticated", error: error.message})
  }
}
...
//protected routes
app.post('/logoutMentor',mentorAuthenticator,mentorPath)
app.post('/logoutUser',userAuthenticator,userPath)
...
app.get('/user/mySessions',userAuthenticator,userPath)
app.get('/mentors',userAuthenticator,userPath)
app.get('/mentors/:id',userAuthenticator,userPath)